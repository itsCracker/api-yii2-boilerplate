...
class Incrementer extends ActiveRecord
{
    public static $db = 'db';
    ...
    {
        return [
            [['year', 'value', 'owner'], 'required'],
        ];
    }
    public static function generate($type, $save = false, $codeType = 'cym')
    {
        $counterValue = null;
        //$owner = isset(Yii::$app->user->identity) ? Yii::$app->user->identity->owner : 0;
